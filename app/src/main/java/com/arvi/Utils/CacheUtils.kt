...
object CacheUtils {
    ...
    // Get file
    //Context.getExternalFilesDir() --> SDCard/Android/data/package name/files/ directory of your application, generally put some long-term saved data
